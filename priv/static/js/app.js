...
var Channel = class {
  constructor(topic, params, socket) {
    ...
    this.joinPush.receive("timeout", () => {
      ...
      let leavePush = new Push(this, CHANNEL_EVENTS.leave, closure$1({}), this.timeout);
      leavePush.send();
      this.state = CHANNEL_STATES.errored;
      this.joinPush.reset();
      if (this.socket.isConnected()) {
  ...
  leave(timeout = this.timeout) {
    ...
    let leavePush = new Push(this, CHANNEL_EVENTS.leave, closure$1({}), timeout);
...
var Socket = class {
  constructor(endPoint, opts = {}) {
    ...
    this.params = closure$1(opts.params || {});
